...
public class HealthEngine {
    ...
    @Transactional
    protected void updateHealthStatus(Human human) {
    ...
    public double calculateHealthCareAccess(int regionId) {
        ...
        switch (regionType) {
            case 0: return 1.0; // 发达地区
            case 1: return 0.7; // 中等地区
            case 2: return 0.4; // 欠发达地区
            default: return 0.7;
        }
    }
